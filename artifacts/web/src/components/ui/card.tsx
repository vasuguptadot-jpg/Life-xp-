...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-white/[0.07] bg-white/[0.04] backdrop-blur-2xl text-card-foreground",
      "shadow-[0_4px_24px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.06)]",
      className
    )}
    {...props}
  />
